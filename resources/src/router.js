...
const baseRoutes = [
    {
        ...
        children: [
            ...
            // Shipping Settings
            {
                path: "/app/settings/shipping_companies",
                component: () => import("./views/app/pages/settings/shipping/ShippingCompanies"),
                name: "shipping_companies"
            },
            {
                path: "/app/settings/shipping_methods",
                component: () => import("./views/app/pages/settings/shipping/ShippingMethods"),
