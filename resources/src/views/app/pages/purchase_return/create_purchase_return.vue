                    ...
                    <tbody>
                      ...
                      <tr>
                        <td class="bold">{{$t('Discount')}}</td>
                         <td>{{formatPriceWithSymbol(currentUser.currency, purchase_return.discount, 2)}}</td>
                      </tr>
                      <tr>
                        <td class="bold">{{$t('Shipping')}}</td>
                         <td>{{formatPriceWithSymbol(currentUser.currency, purchase_return.shipping, 2)}}</td>
                      </tr>
                      <tr>
                        <td>
