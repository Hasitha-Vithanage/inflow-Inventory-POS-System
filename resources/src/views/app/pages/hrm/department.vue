      ...
      >
        ...
        <template slot="table-row" slot-scope="props">
          <span v-if="props.column.field == 'actions'">
            <a @click="Edit_Department(props.row)" class="btn-action btn-edit" title="Edit" v-b-tooltip.hover>
              <Edit size="16" :stroke-width="2" />
            </a>
            <a @click="Remove_Department(props.row.id)" class="btn-action btn-delete" title="Delete" v-b-tooltip.hover>
