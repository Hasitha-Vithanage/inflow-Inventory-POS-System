    ...
    <div class="auth-page">
      ...
      <section class="auth-panel">
        <div class="auth-panel-inner">
          <header>
            <h2 class="panel-title">{{ __('Reset Password') }}</h2>
          ...
          <form method="POST" action="{{ route('password.update') }}" novalidate>
            ...
            <div class="field">
              ...
              <div class="input-shell">
                ...
                <input id="email" type="email" name="email" value="{{ old('email') }}" placeholder="you@company.com" required autocomplete="email" />
              </div>
            </div>
            ...
            <div class="field">
              ...
              <div class="input-shell">
                ...
                <button type="button" class="toggle-password" data-target="password-confirm">Show</button>
              </div>
            </div>
